...
class PhotographersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photographer" do
    assert_difference('Photographer.count') do
      post photographers_url, params: { photographer: { description: @photographer.description, name: @photographer.name } }
    end
  ...
  test "should update photographer" do
    patch photographer_url(@photographer), params: { photographer: { description: @photographer.description, name: @photographer.name } }
